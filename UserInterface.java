...
extends JFrame {
    ...
    public UserInterface(GameEngine gameEngine) {
        ...
        this.upIcon = new ImageIcon((class$egoproject$UserInterface == null ? (class$egoproject$UserInterface = UserInterface.class$("egoproject.UserInterface")) : class$egoproject$UserInterface).getResource("arrowup.png"));
        this.rightIcon = new ImageIcon((class$egoproject$UserInterface == null ? (class$egoproject$UserInterface = UserInterface.class$("egoproject.UserInterface")) : class$egoproject$UserInterface).getResource("arrowright.png"));
        this.leftIcon = new ImageIcon((class$egoproject$UserInterface == null ? (class$egoproject$UserInterface = UserInterface.class$("egoproject.UserInterface")) : class$egoproject$UserInterface).getResource("arrowleft.png"));
        this.downtIcon = new ImageIcon((class$egoproject$UserInterface == null ? (class$egoproject$UserInterface = UserInterface.class$("egoproject.UserInterface")) : class$egoproject$UserInterface).getResource("arrowdown.png"));
        this.lookIcon = new ImageIcon((class$egoproject$UserInterface == null ? (class$egoproject$UserInterface = UserInterface.class$("egoproject.UserInterface")) : class$egoproject$UserInterface).getResource("look.png"));
        this.takeIcon = new ImageIcon((class$egoproject$UserInterface == null ? (class$egoproject$UserInterface = UserInterface.class$("egoproject.UserInterface")) : class$egoproject$UserInterface).getResource("take.png"));
        this.useIcon = new ImageIcon((class$egoproject$UserInterface == null ? (class$egoproject$UserInterface = UserInterface.class$("egoproject.UserInterface")) : class$egoproject$UserInterface).getResource("use.png"));
        this.talkIcon = new ImageIcon((class$egoproject$UserInterface == null ? (class$egoproject$UserInterface = UserInterface.class$("egoproject.UserInterface")) : class$egoproject$UserInterface).getResource("talk.png"));
        this.helpIcon = new ImageIcon((class$egoproject$UserInterface == null ? (class$egoproject$UserInterface = UserInterface.class$("egoproject.UserInterface")) : class$egoproject$UserInterface).getResource("help.png"));
